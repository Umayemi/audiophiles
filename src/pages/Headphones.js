  ...
  return (
    <div>
      <div className=' bg-black w-full'>
        ...
        <h1 className=' text-center text-white uppercase py-[50px] text-[40px]'>Headphones</h1>
      </div>
      <div>
        {Headphone.map((item, index) => (
          <div
            className={` block lg:flex mx-[5%] md:mx-[10%] lg:mx-[100px]  justify-between items-center my-[100px] ${index % 2 !== 0 ? 'flex-row-reverse' : '' 
              }`}
            key={item.id}
          >
...
export default connect(mapStateToProps, mapDispatchToProps)(Headphones)
