    ...
    <div>
      ...
      <div>
        {Speaker.map((item, index) => (
          <div
            className={` lg:flex mx-[5%] block md:mx-[10%] lg:mx-[100px] justify-between items-center   my-[100px] ${index % 2 !== 0 ? 'flex-row-reverse' : '' // Apply flex-row-reverse class to even-indexed items
              }`}
            key={item.id}
          >
